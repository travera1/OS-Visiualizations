...
<div class="container p-3 my-3 border bg-light rounded">
  ...
  <div class="row">
	...
	<div class="card">
            ...
            <a type="button" class="btn btn-primary" href="http://cs.newpaltz.edu/p/f21-13/v4/2-replace/index.php" style="float: right;">Page Replacement</a>
 	 </div>
	</div>
  ...
  <div class="card">
            ...
            <a type="button" class="btn btn-dark" href="http://cs.newpaltz.edu/p/f21-13/v4/1-cpu/index.php" style="float: right;">CPU Scheduling</a>
 	 </div>
	</div>
...
<div class="col-4">
  ...
  <div class="card">
            ...
            <a type="button" class="btn btn-info" href="http://cs.newpaltz.edu/p/f21-13/v4/4-memory/index.php" style="float: right;">Memory Allocation</a>
 	 </div>
	</div>
...
<div class="col-4">
	...
	<div class="card">
            ...
            <a type="button" class="btn btn-info" href="http://cs.newpaltz.edu/p/f21-13/v4/5-files/index.php" style="float: right;">File Allocation</a>
 	 </div>
	</div>
