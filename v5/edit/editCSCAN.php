<?php 
      ...
      if(isset($_POST['submit'])){
        if(empty($_POST['input'])){
            ...
            $filename="../../files/p6-disk-input-cscan.txt";
            $newData = $_POST['input'];
        ...
        if(empty($_POST['output'])){
            ...
            $filename="../../files/p6-disk-output-cscan.txt";
...
<body>
    ...
    <?php 
        ...
        $output = file_get_contents("/var/www/projects/f21-13/html/files/p6-disk-output-cscan.txt");
        $input = file_get_contents("/var/www/projects/f21-13/html/files/p6-disk-input-cscan.txt"); ?>
            ...
            <form action="editCSCAN.php" method="POST">
                <div>
                    <div class="columns">
                        ...
                        <div class="field column" style="max-width: 500px;">
                            <label for="output">Output cscan:</label>
