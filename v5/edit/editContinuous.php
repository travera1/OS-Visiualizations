<?php 
      ...
      if(isset($_POST['submit'])){
        if(empty($_POST['input'])){
            ...
            $filename="../../files/p5-file-input-continuous.txt";
            $newData = $_POST['input'];
...
<body>
    ...
    <?php 
        ...
        $input = file_get_contents("/var/www/projects/f21-13/html/files/p5-file-input-continuous.txt");?>
        ...
        <div>
            <form action="editContinuous.php" method="POST">
                <div class="columns">
                    ...
                    <div class="field" style="max-width: 500px;">
                        <label for="output">Output Continuous:</label>
